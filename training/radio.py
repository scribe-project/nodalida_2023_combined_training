...
Path("wav2vec2-large-voxrex-300m-radio").mkdir(parents=True, exist_ok=True)
print("Push to hub")
tokenizer.push_to_hub(
    repo_id="scribe-project/wav2vec2-large-voxrex-300m-radio",
    use_temp_dir=False,
)
